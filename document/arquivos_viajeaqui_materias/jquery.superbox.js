...
;(function($) {
        ...
        iframe: function($elt, curSettings) {
            ...
            $elt.click(function() {
                ...
                $.superbox.wait(function() {
                    ...
                    // iframe element
                    var $iframe = $('<iframe allowtransparency="true" title="'+ $elt.text() +'" src="'+ $elt.attr("href") +'" name="'+ $elt.attr("href") +'" frameborder="0" scrolling="no" width="'+ curSettings.boxWidth +'" height="'+ curSettings.boxHeight +'"></iframe>');
    ...
    function createElements() {
        ...
        // Add close button
        $closeBtn = $('<div class="close"><a tabindex="0" role="button"><strong><span>'+ settings.closeTxt +'</span></strong></a></div>').prependTo($superbox).find("a");
